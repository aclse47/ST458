...
covariate_vars <- setdiff(colnames(df_with_features), c(response_vars, 'date', 'symbol', 'residual', 'residual_lag1', 'residual_lag2', colnames(df_with_features %>% dplyr::select(matches("bwd")))))
